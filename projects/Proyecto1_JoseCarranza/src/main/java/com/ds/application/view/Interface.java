...
import com.ds.application.view.components.sidebar.HeapControlPanel;
...
public class Interface {
    ...
    public Interface() {
        ...
        appRoot = new StackPane(root, toast);

        header = new Views(
                this::showBinaryTreeView,
                this::showHuffmanView,
                this::showMinHeapView,
                this::showMaxHeapView
        );

        root.setStyle("-fx-background-color: #DBE8D9;");
    ...
    private void showWelcomeView() {
        ...
        container.setStyle(
                ...
                "-fx-border-radius: 18;" +
                "-fx-effect: dropshadow(gaussian, rgba(52,76,61,0.12), 22, 0.25, 0, 8);"
        );
        ...
        divider.setStyle("-fx-background-color: #8EA58C;");
        ...
        wrapper.setStyle("-fx-background-color: #DBE8D9;");
    ...
    private void showBinaryTreeView() {
        ...
        bottomWrap.setStyle("-fx-background-color: #DBE8D9;");
    ...
    private void showHuffmanView() {
        ...
        HuffmanAlgorithmControlPanel panel = new HuffmanAlgorithmControlPanel(visualizer, toast);

        StackPane leftWrap = new StackPane(panel);
        leftWrap.setPadding(new Insets(18, 10, 18, 18));

        StackPane centerWrap = new StackPane(visualizer);
        centerWrap.setPadding(new Insets(18, 18, 18, 10));
        centerWrap.setStyle("-fx-background-color: #DBE8D9;");
    ...
    private void showMinHeapView() {
        root.setTop(header);

        HeapVisualizer visualizer = new HeapVisualizer();
        HeapControlPanel panel = new HeapControlPanel(visualizer, true, toast);
    ...
    private void showMaxHeapView() {
        root.setTop(header);

        HeapVisualizer visualizer = new HeapVisualizer();
        HeapControlPanel panel = new HeapControlPanel(visualizer, false, toast);
