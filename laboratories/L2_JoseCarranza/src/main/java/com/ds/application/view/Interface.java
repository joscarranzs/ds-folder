...
public class Interface {
    ...
    // Wrapper global para poner notificaciones encima de toda la interfaz
    ...
    public Interface() {
        ...
        // Creo la notificación global
        toast = new ToastNotification();

        // Envuelvo la app y la notificación en un StackPane
        appRoot = new StackPane(root, toast);

        // Header con todas las vistas principales
        header = new Views(
    ...
    private void showHuffmanView() {
        ...
        root.setLeft(new HuffmanAlgorithmControlPanel(visualizer, toast));
